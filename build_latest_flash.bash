...
if [ $? != 0 ] ; then
	...
	echo "         To install wget, issue the following commands after installing MacPorts :"
	echo ""
	echo "              $ sudo sudo port selfupdate"
	echo "              $ sudo port install wget"
	echo ""
	echo "     (3) Download and install via redux package :"
	echo "         http://rudix.org/packages/wget.html"
